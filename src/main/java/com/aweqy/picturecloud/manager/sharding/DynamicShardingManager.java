package com.aweqy.picturecloud.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // picture_cloud.picture_112321321,picture_cloud.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "picture_cloud." + tableName) // 确保前缀合法
